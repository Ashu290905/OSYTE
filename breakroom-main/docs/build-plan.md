...
- **TXT-04 soft failure**: no match → return original value, no exception. Lookup is case-insensitive (casefold) so mixed-case `from_value` entries in config work regardless of whether TXT-01 ran first.
